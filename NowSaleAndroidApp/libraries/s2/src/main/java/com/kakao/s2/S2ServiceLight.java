...
class S2ServiceLight {
    ...
    S2ServiceLight(Context context, IConfiguration configuration) {
    ...
    public synchronized static void init(Application application, int batchSize) {
        ...
        if (mInstance == null) {
            ...
            mInstance = new S2Service(application.getApplicationContext(), KakaoUtilService.Factory.getInstance().getAppConfiguration(application.getApplicationContext()));
        }
        ...
        try {
            ...
            KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<EventsLogResponse>(callback) {
                ...
                public EventsLogResponse call() throws Exception {
                    return S2Api.getInstance().requestPublishingEvents(configuration, null, copiedEvents);
                }
            });
        } catch (Exception e) {
            Logger.e(e.toString());
