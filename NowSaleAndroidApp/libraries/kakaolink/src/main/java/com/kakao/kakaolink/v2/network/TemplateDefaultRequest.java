...
class TemplateDefaultRequest extends KakaoLinkTemplateRequest {
    ...
    public TemplateDefaultRequest(final IConfiguration configuration, final Map<String, Object> templateObject) {
        super(configuration, null);
        this.templateObject = templateObject;
        this.jsonObject = null;
    }

    public TemplateDefaultRequest(final IConfiguration configuration, final String appKey, final Map<String, Object> templateObject) {
        super(configuration, appKey);
        this.templateObject = templateObject;
        this.jsonObject = null;
    }

    TemplateDefaultRequest(final IConfiguration configuration, final TemplateParams templateParams) {
        super(configuration, null);
        this.templateObject = null;
        this.jsonObject = templateParams.toJSONObject();
    }

    TemplateDefaultRequest(final IConfiguration configuration, final String appKey, final TemplateParams templateParams) {
        super(configuration, appKey);
        this.templateObject = null;
        this.jsonObject = templateParams.toJSONObject();
    }
