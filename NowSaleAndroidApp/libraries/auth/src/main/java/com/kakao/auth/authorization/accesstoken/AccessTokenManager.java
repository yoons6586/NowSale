...
public interface AccessTokenManager {
    ...
    class Factory {
        ...
        public static AccessTokenManager initialize(final Context context, final ApprovalType approvalType) {
            if (accessTokenManager == null) {
                KakaoUtilService utilService = KakaoUtilService.Factory.getInstance();
                IConfiguration configuration = utilService.getAppConfiguration(KakaoSDK.getAdapter().getApplicationConfig().getApplicationContext());
                accessTokenManager = new DefaultAccessTokenManager(configuration, NetworkService.Factory.getInstance(), approvalType);
            }
