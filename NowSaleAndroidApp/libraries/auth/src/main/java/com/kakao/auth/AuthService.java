...
public class AuthService {
     ...
     */
    @Deprecated
    public Future<Integer> requestShowAgeAuthDialog(final AccountResponseCallback callback, final Bundle ageAuthParams, final boolean useSmsReceiver) {
        return KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Integer>(callback) {
            ...
            public Integer call() {
                ...
                return DefaultAgeAuthService.getInstance().requestAgeAuth(ageAuthParams, activity, useSmsReceiver);
            }
        });
    }
     ...
     * @return {@link AgeAuthStatus} 연령인증 요청 응답 status
     */
    public Future<Integer> requestShowAgeAuthDialog(final AccountResponseCallback callback, final Bundle ageAuthParams, final Activity activity) {
        return KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Integer>(callback) {
            @Override
            public Integer call() {
                ...
                return DefaultAgeAuthService.getInstance().requestAgeAuth(ageAuthParams, activity, useSms);
            }
        });
    }
