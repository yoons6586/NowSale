...
public interface AuthNetworkService {
    ...
    class Factory {
        ...
        static {
            ...
            authNetworkService.setConfiguration(KakaoUtilService.Factory.getInstance().getAppConfiguration(KakaoSDK.getAdapter().getApplicationConfig().getApplicationContext()));
