package com.example.yoonsung.nowsale.kakao;
...
public class PlusFriendService {
    ...
    public static PlusFriendService instance = new PlusFriendService();
    ...
    Uri createPlusFriendUrl(final Context context, final String plusFriendId, final String path) throws KakaoException {
        ...
        try {
            ...
            return createPlusFriendUrl(plusFriendId, path, configuration.getAppKey(), configuration.getKAHeader());
        } catch (Exception e) {
...
//            context.startActivity(browserIntent);
    ...
    Uri createPlusFriendUrl(final String plusFriendId, final String path, final String appKey, final String kaHeader) {
        return new Uri.Builder()
                ...
                .authority(ServerProtocol.PLUS_FRIEND_AUTHORITY)
    ...
    IConfiguration getConfiguration(final Context context) {
        return IConfiguration.Factory.createConfiguration(context);
    }
