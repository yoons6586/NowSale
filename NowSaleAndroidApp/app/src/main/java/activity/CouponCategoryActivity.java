...
import com.example.yoonsung.nowsale.ClientMyInfoActivity;
import com.example.yoonsung.nowsale.Config;
import com.example.yoonsung.nowsale.Dialog;
import com.example.yoonsung.nowsale.LoginCancelPopupActivity;
import com.example.yoonsung.nowsale.R;
import com.example.yoonsung.nowsale.SliderAdvertisementImageAdapter;
...
//            ownerCouponData.setChoose("sale");
            ...
            startActivityForResult(new Intent(CouponCategoryActivity.this,OwnerChangeInfo.class),loginResult);
        }
